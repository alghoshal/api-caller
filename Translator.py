...
CONTENT_ID = os.getenv('CONTENT_ID', '22')
...
if content is not None:
    translation = invokeLlm("Translate the following to "+TRANSLATION_LANGUAGE +
                            " (only include the translation in the response): " + content)
